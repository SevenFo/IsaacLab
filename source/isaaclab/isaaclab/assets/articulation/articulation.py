    ...
    def _process_actuators_cfg(self):
        ...
        for actuator_name, actuator_cfg in self.cfg.actuators.items():
            ...
            if isinstance(actuator, ImplicitActuator):
                ...
                # effort limits
                if (
                    actuator.effort_limit_sim is None
                    and actuator.effort_limit is not None
                ):
                    omni.log.warn(
                    ...
                    actuator.effort_limit_sim is not None
                    and actuator.effort_limit is not None
                ):
                    omni.log.warn(
                ...
                # velocity limits
                if (
                    actuator.velocity_limit_sim is None
                    and actuator.velocity_limit is not None
                ):
                    omni.log.warn(
                    ...
                    actuator.velocity_limit_sim is not None
                    and actuator.velocity_limit is not None
                ):
                    omni.log.warn(
                ...
                self.write_joint_effort_limit_to_sim(
                    ...
                    else actuator.effort_limit_sim,
