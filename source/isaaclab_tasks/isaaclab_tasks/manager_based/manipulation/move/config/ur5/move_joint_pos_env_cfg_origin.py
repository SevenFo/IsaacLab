...
from IsaacLab.source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.move.move_env_cfg_origin import MoveEnvCfg
...
class EventCfg:
    ...
    #         "pose_range": {"x": (0.600, 0.600), "y": (-2.000, -2.000), "z": (2.818, 2.818), "yaw": (0, 0)},
    ...
    #     mode="reset",
    #     params={
    #         # "pose_range": {"x": (0.58, 0.62), "y": (-1.87, -1.83), "z": (2.885, 2.885), "yaw": (2.6, 3.6)},
    #         "pose_range": {"x": (0.6, 0.6), "y": (-1.85, -1.85), "z": (2.885, 2.885), "yaw": (3.14, 3.14)},
    ...
    def __post_init__(self):
        ...
        self.scene.spanner = RigidObjectCfg(
            ...
            spawn=UsdFileCfg(usd_path="/data/shared_folder/IssacAsserts/Projects/Collected_ROOM_set_fix_0403/Toolbox_no_joint.usd",
                             ...
                             semantic_tags=[("class", "spanner")],
            ),
        ) 
        
        self.scene.desk = RigidObjectCfg(
            prim_path="{ENV_REGEX_NS}/Desk",
            init_state=RigidObjectCfg.InitialStateCfg(pos=[0.73461, -2.82622, 1.82532], rot=[0, 0, 0, 1]),
            spawn=UsdFileCfg(usd_path="/data/shared_folder/IssacAsserts/Projects/Collected_ROOM_set_fix_0403/Desk.usd",
                             scale=(1.0, 1.0, 1.0),
        ...
        #     init_state=RigidObjectCfg.InitialStateCfg(pos=[0.6, -2.0, 2.818], rot=[1, 0, 0, 0]),
        #     spawn=UsdFileCfg(usd_path="/data/shared_folder/IssacAsserts/Projects/Collected_assemble_inner/assemble_inner.usdc",
        #                      scale=(1.0, 1.0, 1.0),
        ...
        #     init_state=RigidObjectCfg.InitialStateCfg(pos=[0.6, -1.85, 2.885], rot=[0, 0, 0, 1]),
        #     spawn=UsdFileCfg(usd_path="/data/shared_folder/IssacAsserts/Projects/Collected_assemble_outer/assemble_outer.usdc",
        #                      scale=(1.0, 1.0, 1.0),
