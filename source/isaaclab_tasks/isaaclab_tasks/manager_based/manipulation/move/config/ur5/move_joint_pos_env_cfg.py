...
class EventCfg:
    ...
    randomize_object_positions = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (1.15, 1.28), "y": (-3.4, -3.48), "z": (2.9, 2.9), "yaw": (-0.1, 0.1)},
...
class UR5BoxMoveEnvCfg(MoveEnvCfg):
    def __post_init__(self):
        ...
        self.scene.spanner = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=[1.4, -2.5, 2.9], rot=[0.70711, 0.70711, 0, 0]),
            spawn=UsdFileCfg(usd_path="/data/shared_folder/IssacAsserts/Projects/Collected_ROOM_set_fix_0409/spanner.usd",
                             scale=(1.3, 1.6, 1.3),
        ...
        #     offset=CameraCfg.OffsetCfg(pos=(1.175, -2.29804, 3.19415), rot=(0, 0, 0.6157, 0.7880), convention="opengl"),
        #     # offset=CameraCfg.OffsetCfg(pos=(1.175, -2.43562, 3.30584), rot=(1, 0, 0, 0), convention="opengl"),
        #     width=256,
        #     height=256,
        #     data_types=["rgb", "depth"],
        #     depth_clipping_behavior="clamp",
        #     debug_vis=True         
        # )
        ...
        #     offset=CameraCfg.OffsetCfg(pos=(0.07763, -3.56398, 3.63566), rot=(0.57923, 0.40558, -0.40558, -0.57923), convention="opengl"),
        #     width=256,
        #     height=256,
        #     data_types=["rgb", "depth"],
        #     depth_clipping_behavior="clamp",
        ...
        #     spawn = PinholeCameraCfg(vertical_aperture=None, focal_length=12.5),
        #     offset=CameraCfg.OffsetCfg(pos=(-0.07, 0.0, 0.0), rot=(0, 0.70711, -0.70711, 0), convention="opengl"),
        #     width=256,
        #     height=256,
        #     data_types=["rgb", "depth"],
        #     depth_clipping_behavior="clamp",
        ...
        self.scene.contact_sensor = ContactSensorCfg(
            ...
            prim_path="{ENV_REGEX_NS}/Box/red_toolbox/Toolbox/box_lower/Button/button", 
            force_threshold=0.1,    
            filter_prim_paths_expr=["{ENV_REGEX_NS}/Robot/ur5/gripper/right_inner_finger", "{ENV_REGEX_NS}/Robot/ur5/gripper/left_inner_finger"], 
            update_period=0.01,     
        ) 